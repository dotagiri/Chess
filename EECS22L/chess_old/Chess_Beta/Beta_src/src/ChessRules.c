...
{
	printf(	"* White is always first to move and players take turns alternately moving one piece at a time. Movement is required.\n"
			...
			"* Stalemate also occurs when a player makes the same move three times.\n"
			"* Each type of piece has its own method of movement. Go to the glossary to check the moves of each of the pieces.\n"
			"* A piece may be moved to another position or may capture an opponent's piece, replacing on its square (en passant being the only exception, check  special moves section).\n"
